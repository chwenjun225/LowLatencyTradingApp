...
namespace Common {
    struct TCPServer {
        ...
        /// Check for new connections or dead connections and update containers 
        // that track the sockets.
        auto poll() noexcept -> void;

        /// Publish outgoing data from the send buffer and read incoming data 
    ...
    public:
        ...
        /// Collection of all sockets, sockets for incoming data, sockets for 
        // outgoing data and dead connections.
        ...
        /// Function wrapper to call back when all data across all TCPSockets has 
        // been read and dispatched this round.

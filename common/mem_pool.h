...
namespace Common {
    ...
    class MemPool final {
        public:
            ...
            // Allocate a new object of type T, use placement new to initialize 
            // the object, mark the block as in-use and return the object.
        ...
        private:
            ...
            // It is good to have objects on the stack but performance starts getting 
            // worse as the size of the pool increases.

...
namespace Exchange {
    ...
    public:
        ...
        FIFOSequencer(
            ...
            Logger *logger) : incoming_requests_(client_requests), logger_(logger) {}
        ~FIFOSequencer() {}
        ...
        auto addClientRequest(Nanos rx_time, const MEClientRequest &request) {
            ...
            pending_client_requests_.at(pending_size_++) = std::move(
        ...
        auto sequenceAndPublish() {
            ...
            std::sort(
                pending_client_requests_.begin(), 

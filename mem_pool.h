    ...
    class MemPool final {
        public:
            ...
            auto deallocate(const T *elem) noexcept {
                ...
                ASSERT(elem_index >= 0 && static_cast<size_t>(elem_index) < store_.size(), "Element being deallocated does not belong to this MemoryPool");
        ...
        private:
            ...
            // We could have chosen to use a std::array that would allocate the memory on the stack instead of the heap
